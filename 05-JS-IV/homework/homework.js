...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
  objeto[property] = null;    // objeto.nombre = objeto['nombre']
  return objeto;
}
...
function invocarMetodo(objeto, metodo) {
  ...
  // Tu código:
  objeto[metodo](); // LOS PARENTESIS SIEMPRE FUERA DE LOS CORCHETES PARA LLAMAR UNA FUNCION
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  var producto = objetoMisterioso.numeroMisterioso * 5; // objetoMisterioso['numeroMisterioso'] tambien funciona.
  return producto;
}
...
function tieneEmail(usuario) {
  ...
  // Tu código:
  if (usuario.email == undefined) return false; // if(usuario.email) return true;
