...
function saludo(idioma) {
  ...
  else (idioma !== 'aleman' || 'mandarin' || 'ingles' || undefined); {
    return 'Hola!';
  }
}
...
function fizzBuzz(numero) {
  ...
  if (((numero / 3) % 1 === 0) && ((numero / 5) % 1 === 0)) return 'fizzbuzz';
  if ((numero / 3) % 1 === 0) return 'fizz';
  if ((numero / 5) % 1 === 0) return 'buzz';
  else return numero;
}
...
function esVerdadero(valor){
  ...
  else (valor === false); return 'Soy falso';
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var array = [6, 12, 18, 24, 30, 36, 42, 48, 54, 60]
}
